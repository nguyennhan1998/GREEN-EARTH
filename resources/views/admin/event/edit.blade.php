                                ...
                                <table class="table table-hover">
                                    <form method="POST" role="form" action="{{url("admin/events/update/{$event->__get("id")}")}}">
                                        ...
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input style="color:black;"  value="{{$event->__get("title")}}" type="text" name="title" class="form-control" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input style="color:black;" value="{{$event->__get("image")}}" type="text" name="image" class="form-control" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <input  style="color:black;" value="{{$event->__get("description")}}" type="text" name="description" class="form-control" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  style="color:black;" value="{{$event->__get("start_at")}}" type="date" name="start_at" class="form-control" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <label>End At</label>
