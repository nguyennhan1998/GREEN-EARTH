                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="logo" style="text-align: left;">
                                <h1><a href="#">Green Earth Order Information</a></h1>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td style="padding: 0 2.5em; text-align: left;">
                                <div class="text d-flex flex-column">
                                    <h4>{{\Illuminate\Support\Facades\Auth::user()->__get("name")}} Thank You For Purchase Order</h4>
                                    <p>This Is Your shipping Information :</p>
            ...
            <tr>
                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                        ...
                        <td valign="middle" width="25%" style="text-align:left; padding: 0 2.5em;">
                            <span class="price" style="color: #000; font-size: 20px;">{{"$".number_format($item->__get("price"))}}</span>
                        </td>
                    </tr>
                    @endforeach
                    <tr>
                        <td valign="middle" style="text-align:left; padding: 1em 4em;">
                            <p class="btn btn-primary" style="width: 300px">Total Price :${{$total}}</p>
                        </td>
                    </tr>
                </table>
            </tr><!-- end tr -->
