                    ...
                    <div class="col-md-9">
                        <div class="environment-event environment-event-grid">
                            <ul class="row">
                                ...
                                <li class="col-md-6">
                                    <figure>
                                        <a href="{{$event->getEventUrl()}}"><img src="{{$event->getImage()}}" alt=""><i class="fa fa-search-plus"></i></a>
{{--                                        <time datetime="2008-02-14 20:00">12<br>FEB</time>--}}
                                    </figure>
                                    <div class="environment-event-grid-text">
                                        <h5><a href="{{$event->getEventUrl()}}">{{$event->__get("title")}}</a></h5>
                                        ...
                                        <div>
                                            <a href="{{$event->getEventUrl()}}" class="environment-readmore-btn">Read More</a>
                                        </div>
